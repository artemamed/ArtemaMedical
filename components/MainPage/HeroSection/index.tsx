...
export default function HeroSection() {
    ...
    return (
        <div className="min-h-screen px-4 md:px-[5rem]">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 items-center w-full gap-8 ">
                ...
                <div className="text-left">
                    <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-6xl font-semibold mb-4 md:mb-6 leading-10">
                        Revolutionizing <span className="text-[#008080]">Healthcare</span>, One Innovation at a Time
                    </h1>
                    <div className="relative">
                    <p className="text-sm sm:text-base md:text-lg lg:text-xl text-gray-600 w-full leading-10">
