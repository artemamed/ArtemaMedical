...
const TrustedStandard = () => {
  return (
    <div className="px-4 md:px-[2rem] lg:px-[5rem] relative">
      <div className="py-8">
        <h1 className="text-2xl sm:text-3xl md:text-4xl lg:text-5xl font-semibold mb-6 sm:mb-10 leading-tight px-[2rem]">
