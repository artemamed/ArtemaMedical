            ...
            <div className="max-w-screen-lg w-full">
                ...
                <div className="text-center mb-8">
                    ...
                    <p className="text-gray-600 mt-2 max-w-2xl mx-auto text-base sm:text-lg">
                        At Artema Medical, we strive to provide timely and reliable shipping for our surgical instruments and pharmaceutical products. Below are the details of our privacy policy.
                    </p>
                </div>
                ...
                <section className="mb-8 border-b pb-4">
                    ...
                    <p className="text-gray-700 ml-[2rem]">
                        We implement reasonable security measures, but no method is 100% secure. We encourage safe online practices.
                    </p>
                </section>
