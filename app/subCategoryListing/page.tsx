...
const SubCategoryListing = () => {
    ...
    return (
        <>
            <BreadcrumbComponent />
            <h1 className="text-2xl md:text-3xl lg:text-5xl font-semibold mb-6 text-center mt-[1rem] lg:pt-[3rem] text-[#004040]">
                Sleeves & Drill
            </h1>
            <div className="text-end mx-[1rem] lg:mx-[6rem] -mb-[3rem] lg:-mb-1 mr-[1rem] md:mr-[2rem] text-sm sm:text-base">
                Showing all results ...
            </div>
            <div className="relative flex min-h-screen mx-[1rem] lg:mx-[3rem] my-[2rem]">
