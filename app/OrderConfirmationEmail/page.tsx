...
// import { Html, Head, Body, Container, Section, Column, Row, Text, Img, Button } from '@react-email/components';
...
//             </Text>
//             <Text>We are delighted to confirm that your order has been successfully placed. Thank you for choosing us.</Text>
//           </Section>
//           <Section>
...
//             </Row>
//             <Row>
//               <Column>Grand Total</Column>
//               <Column>${grandTotal}</Column>
//             </Row>
//           </Section>
//           <Section className="footer">
//             <Text>Need Help?</Text>
//             <Text>Should you have any questions or require further assistance, our team is here to help.</Text>
//             <Button href="mailto:sales@artemamed.com" className="button">
//               Contact Us
//             </Button>
//           </Section>
//         </Container>
