                    ...
                    <div className="flex items-center justify-center lg:mt-12">
                        <div className="max-w-[90%] md:max-w-[800px] text-center">
                            ...
                            <div className="text-gray-600 text-sm md:text-base">
                                <p>
                                    <span className="font-medium text-[#6C7275]">Your cart is empty. Start adding items to enjoy shopping!</span>
                                </p>
                            </div>
                            <Button
                                            ...
                                            >
                                                <td className="py-3 md:p-3 flex flex-col md:flex-row items-center gap-4">
                                                    ...
                                                    <div className="space-y-2 text-center md:text-left">
                                                        ...
                                                        <h2 className="text-xs text-[#666666]">size: {item.size}</h2>
                                                        <h2 className="text-xs text-[#666666]">sku: {item.sku}</h2>
                                                        <button
                                                ...
                                                <td className="hidden md:block md: absolute pl-[1rem] xl:pl-[2rem] mt-[2.75rem]">${item.price.toFixed(2)}</td>
                                                <td className=" absolute mt-[9rem] -ml-[7rem] md:mt-0 md:pl-[2rem] xl:pl-[3rem] md:relative">${(item.price * item.quantity).toFixed(2)}</td>
                                            </tr>
                                        ))}
                                    </tbody>
                                </table>
                                ...
                                <table className="w-full text-sm">
                                    <tbody>
                                        ...
                                        <tr className="border-b border-[#E8ECEF]">
                                            ...
                                            <td className="text-right py-3">${freightCharge.toFixed(2)}</td>
                                        </tr>
